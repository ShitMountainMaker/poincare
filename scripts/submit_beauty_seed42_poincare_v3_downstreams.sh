...
RUN_ROOT="${RUN_ROOT:-${REPO_DIR}/outputs/poincare_band_v3/beauty_seed42}"
...
declare -A SEMANTIC_PATHS=(
  ...
  [hyp_0_1]="${RUN_ROOT}/semantic_id_stage/sweeps/hyp_prefix/hyp_prefix_w_0_1/inference/pickle/merged_predictions_tensor.pt"
...
for candidate in base hyp_0_1 hyp_0_2 hyp_0_3; do
  ...
  stdout_log="${HISTORY_DIR}/output_downstream_b42_poincare_v3_${candidate}.txt"
  stderr_log="${HISTORY_DIR}/error_downstream_b42_poincare_v3_${candidate}.txt"
